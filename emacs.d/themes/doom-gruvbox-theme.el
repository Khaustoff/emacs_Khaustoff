...
(def-doom-theme doom-gruvbox
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ((outline-5 &override) :foreground (doom-lighten dark-green 0.25))
   ((outline-6 &override) :foreground (doom-lighten dark-blue 0.4))
   ((outline-7 &override) :foreground (doom-lighten dark-green 0.5))
   ((outline-8 &override) :foreground (doom-lighten dark-blue 0.6))
