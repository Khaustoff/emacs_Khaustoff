...
(def-doom-theme doom-gruvbox-light
  ...
  ((bg
    (cond ((equal doom-gruvbox-light-variant "hard") '("#f9f5d7" "#ffffd7" nil))   ; bg0_h
          (t					     '("#f2e5bc" "#ffffd7" nil))   ; bg0_s
          ((equal doom-gruvbox-light-variant "norm") '("#fbf1c7" "#ffffd7" nil)))) ; bg0
   (bg-alt
  ...
  ((cursor :background base4)
   ...
   (org-agenda-done             :foreground grey)
   ...
   (org-done                    :foreground grey :weight 'bold :bold t)
